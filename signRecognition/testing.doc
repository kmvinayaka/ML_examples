    ...
    while True:
        ...
        for key, value in upper.items():
            ...
            if len(cnts) > 0:
                ...
                #print("ccccccccc",key)
                if (key=='red'):
                    playsound.playsound('stop.mp3', True)
                    print("stop detected")
        ...
        if largestArea > frameArea*0.02:
            ...
            # use function to detect the sign on the found rectangle11
        ...
        if (detectedTrafficSign == 'Turn Right'):
                playsound.playsound('turnright.mp3', True)
                continue
                
        elif (detectedTrafficSign == 'Turn Left'):
                playsound.playsound('turnleft.mp3', True)
                continue


        elif (detectedTrafficSign == 'Turn Back'):
                playsound.playsound('turnback.mp3', True)
                continue

        elif (detectedTrafficSign == 'Move Straight'):
                playsound.playsound('movestraight.mp3', True)
                continue           
